...
const frontDoors: readonly Seed[] = [
  ['/', 'HardMagic Corporation', 'Understand the current agentic media system', 'HardMagic joins human creative authority generative media software agents and accountable delivery in one owned product system', 'Explore products', 'See agentic workflows', t('agentic media', 'owned products', 'human direction'), rel('/products/', '/methods/human-agent-creative-loop/'), v('agentic thesis', 'product constellation', 'working product evidence', 'multimodal proof')],
...
const company: readonly Seed[] = [
  ['/company/', 'Company', 'Assess HardMagic as a corporation and partner', 'HardMagic is a privately owned Delaware corporation building agentic AI and media products around human authority inspectable evidence and durable ownership', 'Start a conversation', 'Explore the operating model', t('agentic AI products', 'generative media systems', 'private ownership'), rel('/products/', '/company/operating-model/'), v('corporate thesis', 'product system', 'agentic operating model', 'selected continuity')],

...
const frontDoors: readonly Seed[] = [
  ['/', 'HardMagic Corporation', 'Understand what HardMagic is now', 'Twenty-five years of creative practice now power an owned GenAI and media product company', 'Explore products', 'Read the company story', t('corporate identity', 'owned products', 'creative practice'), rel('/products/', '/company/'), v('cinematic thesis', 'invention constellation', 'operating-system diagram', 'archival proof')],
...
const company: readonly Seed[] = [
  ['/company/', 'Company', 'Assess HardMagic as a corporation and partner', 'HardMagic is a privately owned Delaware GenAI and media corporation built on more than 25 years of practice', 'Start a conversation', 'Explore company history', t('corporate identity', 'company history', 'product ownership'), rel('/company/history/', '/company/operating-model/'), v('corporate thesis', 'historical arc', 'product portfolio', 'principles')],
